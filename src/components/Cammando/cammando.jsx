                ...
                <div className='flex flex-col lg:flex-row gap-y-8 items-center lg:gap-x-12'>
                    ...
                    <div className=' flex-1 text-center font-satoshi lg:text-left'>
                        ...
                        <motion.p
                            ...
                            whileInView={'show'}
                            viewport={{ once: true, amount: 0.7 }}
                            className=' font-satoshi text-white max-w-lg mx-auto  lg:mx-0 mb-8'><strong>Commando</strong>  is an intelligent assistant designed to assist users in generating appropriate terminal commands based on their descriptions. It serves as a bridge between users who may not be familiar with terminal commands and the powerful capabilities of the command-line interface.     </motion.p>
                        <motion.div
                            ...
                            {
                                user && user.maxqueries > max ?
                                    <Link to={'commando'} className='orange_gradient_btn '>
                                        Get Started
                                    </Link>
                                    :
                                    <div className='tooltip cursor-pointer' data-tip={` ${user ? 'Please upgrade your plan' : 'You must log in before proceeding.'}`}>

                                        <button className='cursor-not-allowed'>Get Started</button>
                                    </div>

                            }
                            <a href="https://youtu.be/vEjwyc0C0P8" target={'_blank'} rel="noreferrer"  className='orange_gradient font-satoshi'>
                                How it works
                            </a>
                        </motion.div>
                    </div>
