                ...
                <div className='flex flex-col lg:flex-row gap-y-8 items-center lg:gap-x-12'>
                    ...
                    <div className=' flex-1 text-center font-satoshi lg:text-left'>
                        ...
                        <motion.p
                            ...
                            <strong>ExamMaster</strong>  is an intelligent chatbot designed to guide you through the challenging exams in the C language. With its vast knowledge base, it offers expert advice, practical examples, and step-by-step explanations to enhance your understanding and achieve top scores.
                        </motion.p>
                        <motion.div
                            ...
                            className='flex  max-w-max gap-x-8 items-center mb-12 mx-auto lg:mx-0'>
                            {
                                user && user.maxqueries > max ?
                                    <Link to={'exam'} className='orange_gradient_btn '>
                                        Get Started
                                    </Link>
                                    :
                            ...
                            <a href="https://youtu.be/B7SHK6YKujw" target={'_blank'} rel="noreferrer"  className='orange_gradient font-satoshi'>
                                How it works
                            </a>
                        </motion.div>
                    </div>
