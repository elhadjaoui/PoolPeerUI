                ...
                <div className='flex flex-col lg:flex-row gap-y-8 items-center lg:gap-x-12'>
                    ...
                    <div className=' flex-1 text-center font-satoshi lg:text-left'>
                        ...
                        <motion.p
                            ...
                            whileInView={'show'}
                            viewport={{ once: true, amount: 0.7 }}
                            className=' font-satoshi text-white max-w-lg mx-auto  lg:mx-0 mb-8'> <strong>CodeGenius</strong> is An advanced C programming chatbot. Generates C code, debugs, reviews, and cleans your code. Offers a 25 line feature for professional code formatting. Enhance coding efficiency with expert assistance.  </motion.p>
                        <motion.div
                            ...
                            className='flex  max-w-max gap-x-8 items-center mb-12 mx-auto lg:mx-0'>
                            {
                                user && user.maxqueries > max ?
                                    <Link to={'codegenius'} className='orange_gradient_btn '>
                                        Get Started
                                    </Link>
                                    :
                            ...
                            <a href="https://youtu.be/kI8rr2czOjM" target={'_blank'} rel="noreferrer"  className='orange_gradient font-satoshi'>
                                How it works
                            </a>
                        </motion.div>
                    </div>
